...
\paragraph{Design for Location effect:} The experiment was set up based on the gene expression data with two groups. The groups are defined based on the Genotype and Empty Vector (EV). For each of the of the Genotype, gene expression data were collected in presence or absence of iron sufficiency. Two hypothesis were of primary interest. The Genotype effect and the Genotype and iron sufficiency interaction effect. 
