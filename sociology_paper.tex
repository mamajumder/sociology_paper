...
For a lineup with a predicted random effect of one standard deviation, i.e. we move away one standard deviation of lineup variation by adding 2.293 to each of the exponent terms in the equation, this difference reduces to 0.024. For two standard deviations it further reduces to 0.003 which is practically very small. Figure~\ref{fig:practical_impact_graduate} illustrates this example showing the proportions of correct responses due to graduate degree as compared to high school degree. The highest practical difference in proportions of correct response is estimated as 0.045 which is very negligible. The difference further diminishes if we move one or two standard deviation of lineup variability. A similar calculation shows the same negligible impact of age level 36-40 (0.0533 at most)  and country (0.0424 at most) on the probability of correct response. Thus even though some of the factor levels are statistically significant, their practical impact is negligible.

\begin{figure}[htbp] 
   \centering
%   \includegraphics[width=6.5in]{learning_trend.pdf} 
    \includegraphics[width=4in]{practical_impact_graduate.pdf} 
   \caption{Proportion of correct responses due to graduate degree as compared to high school degree for an 18-25 year old female in the United States. Even though graduate degree is statistically significant, the largest practical difference in proportion correct is  0.045 which is very negligible. The difference even diminishes as we move away one or two standard deviations ($\sigma_{\ell} =2.293$) of lineup variability.}
