...
\begin{figure}[hbtp] 
   \centering
   \includegraphics[width=0.49\textwidth]{tower.pdf} \hfill
   \includegraphics[width=0.50\textwidth]{freedom-sim.pdf} 
   \caption{ \label{fig:tower} Electoral building plot of the results of the 2012 U.S. Presidential Election (left). On the right a histogram of 10,000 simulations from the same model. The $p$-value of observing results as extreme as in the  2012 U.S. election based on the bootstrap is 0.0533 (with Bootstrap standard error of 0.002).}
>>>>>>> example
\end{figure}
...
2 &  Scatter plot & \begin{minipage}[t]{3cm}  \begin{center} \scalebox{0.45}{\includegraphics{stat_beta_k.pdf}} \end{center} \end{minipage} & Of the scatter plots below which one shows data that has steepest slope? \\ 
  ...
  4 & Polar vs Cartesian & \begin{minipage}[t]{3cm} \begin{center}  \scalebox{0.35}{\includegraphics{stat_polar.pdf}} \end{center} \end{minipage} &Which plot is different? \\ 
  5 & Hist vs density & \begin{minipage}[t]{3cm} \begin{center}  \scalebox{0.35}{\includegraphics{stat_density.pdf}} \end{center} \end{minipage} &In which plot is the blue group furthest to the right?\\ 
