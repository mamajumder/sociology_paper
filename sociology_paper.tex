...
\subsection{Learning Trend} Model \eqref{eqn:trend_time} is fitted to the data from experiment 5, 6, and 7. The results are shown in Table \ref{tbl:model_result_time}.  The model is fitted using R function $lmer()$ from package $lme4$. To obtain the $p$-values of fixed effect parameters, normal approximation is used $Z$ scores are computed accordingly. 
...
\begin{table}[htbp]\centering
\caption{Parameter estimates of Model \eqref{eqn:trend_time} fitted for log time taken to evaluate a lineup. Both fixed effect parameters of Attempt ($\alpha_1$ and $\alpha$) are highly significant for all three experiments 5, 6 and 7.}\begin{tabular}{rrrcccrrcccrrcc}  \hline
& \multicolumn{4}{c} {Experiment 5} & &\multicolumn{4}{c} {Experiment 6} && \multicolumn{4}{c} {Experiment 7}\\
\cline{2-5} \cline{7-10} \cline{12-15}  Effect& Est & SE & Zval & pvalue && Est & SE & Zval & pvalue && Est & SE & Zval & pvalue \\   \hline
Fixed &  &  &  & && &  & & & & & &  & \\ $\mu$ & 3.82 & 0.04 & 97.38 & $<$0.001 & & 3.90 & 0.03 & 118.19 & $<$0.001 && 3.73 & 0.05 & 69.04 & $<$0.001 \\   $\alpha_1$ & 0.33 & 0.04 & 9.35 & $<$0.001 && 0.34 & 0.03 & 11.4 & $<$0.001 && 0.28 & 0.05 & 5.63 & $<$0.001 \\   $\alpha$ & -0.04 & 0.00 & -9.3 & $<$0.001 && -0.04 & 0.00 & -10.19 & $<$0.001 && -0.03 & 0.01 & -4.22 & $<$0.001 \\ 
Rand &  &  &  &  &  & & &&& & & &  & \\   $\sigma^2_l$ & 0.01 & 0.09 &  &  && 0.24 & 0.49 &  &&  & 0.13 & 0.37 &  &  \\   $\sigma^2_u$ & 0.26 & 0.51 &  &  & &0.00 & 0.05 & & &  & 0.00 & 0.05 &  &  \\    $\sigma^2_a$ & 0.00 & 0.03 &  &  & &0.04 & 0.20 & & &  & 0.06 & 0.24 &  &  \\   $\sigma^2$ & 0.21 & 0.46 &  &  & &0.25 & 0.50 &  &  && 0.21 & 0.45 &  &  \\    \hline\end{tabular}
