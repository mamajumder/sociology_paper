...
\caption{Fixed effect parameter estimates of mixed model. Note that attempt is not significant for experiment 2. The continuous covariate lineup difficulty was measured by the $p$-value of the actual plot in the lineup.}\begin{center}\begin{tabular}{llrrrrl}  \hline& Parameters & Estimate & Std..Error & z.value & P-value  & \\   \hline
