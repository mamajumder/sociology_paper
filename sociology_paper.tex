...
Because visual statistical inference relies on human evaluation, it is important to understand the factors that might affect results.  This section provides a brief description of the factors that may influence results.  
