...
\begin{figure}[htbp] 
   \centering
   \includegraphics[width=3.5in]{country_study_bar.pdf} 
   \caption{Countrywise distribution of education level of the MTurk workers participating the experiments. The spike in graduate degree in India may be due to their consideration of undergraduate degree to be graduate degree as well.}
   \label{fig:country_study}
\end{figure}

\begin{figure}[htbp] 
   \centering
   \includegraphics[width=3.5in]{age_study_bar.pdf} 
   \caption{Countrywise distribution of age levels of the MTurk workers participating the experiments.}
   \label{fig:age_study}
\end{figure}
...
\begin{figure}[htbp] 
   ...
   \caption{Words used to explain the reasons for selection of data plot in a lineup show what features of a lineup may influence a non-statistician to examine it. Larger font indicate more people choosing that word. Different color is used just to separate the words.}
   \label{fig:wordle}
\end{figure}
...
\subsection{Learning Trend of the Observer} Each subject participating the experiment has seen multiple number of lineups for evaluations. Suppose $K$ be the number of lineups evaluated by a subject and $A_k$ be the $kth$ attempt, $k=1,2, ..., K$. Since each subject is shown multiple lineups, they have a chance for self learning and do better on lineups shown later in the sequence. They may learn from their previous mistake or they may learn about the features of the plots being evaluated as they progress. Thus if there is any learning trend that should be apparent in proportion correct over $A_k$. But to obtain this we have to adjust for lineup difficulty and individual performances.
...
A plot of absolute residuals against the attempts $A_k$ should reveal the trend if there is any. Figure \ref{fig:learning_trend} shows such plots for three experiments naming experiment 5 through 6. For experiment 5 we see a downward trend in absolute residual as the attempt progress. This may indicate a learning trend but this trend is not statistically significant. We see upward trend for experiment 6 and 7. This could be attributed to the exhaustion of subjects' attempt after some earlier evaluations are made. But again these upward trends are not statistically significant as well.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \caption{Mean absolute residuals vs attempt obtained by adjusting for lineup and subject specific variation. For experiment 5, we see a downward trend which may indicate some learning as attempt progress, but none of the slopes in these three experiments are statistically significant.}
