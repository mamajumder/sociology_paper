...
%\hh{
Let $\pi_{ijk}=  E(Y_{ijk})$ be the probability that  observer $i$ picks the data panel from lineup $j$ in his/her $k$th attempt. We model this in a generalized mixed effects model of the form
