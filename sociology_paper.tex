...
\subsection{Learning Trend of the Observer} Since each subject is shown multiple lineups, they have a chance for self learning and do better on lineups shown later in the sequence. They may learn from their previous mistake or they may learn about the features of the plots being evaluated as they progress. We examine this by fitting generalized mixed effect model presented in \cite{majumder:2012} with lineups and subjects as random effect and no fixed effect. This should give us the estimation of proportion correct responses adjusted for lineup difficulties and individual skills. The resulting residual should show some trend if plotted against attempt. Figure \ref{fig:learning_trend} shows such plots for three experiments naming experiment 5 through 6. For experiment 5 we see a downward trend in absolute residual as the attempt progress. This may indicate a learning trend but this trend is not statistically significant. We see upward trend for experiment 6 and 7 but again they are not statistically significant too.
