...
\subsection{Demographic Factors} Proportions of correct responses and the logarithm of average time taken for each lineup are computed and their distributions are shown as boxplots in Figure \ref{fig:demographic_effect} for different demographic factor levels.
