...
\begin{table*}[hbtp] 
\centering 
\caption{Visual test statistics used in 10 different simulation experiments. The observers are asked different questions to answer while evaluating a lineup. All the experiment data are used to estimate the effect of demographic factors on visual inference while some are used to estimate the learning trend and location effect of actual data in the lineup.} 
\begin{tabular}{m{.5cm}m{2.6cm}m{2cm}m{4.5cm}m{3.5cm}} 
\hline\hline 
Serial & Experiment &  Test Statistic  & Lineup question & Provided data to estimate\\ [0.5ex] % inserts table %heading 
\hline 
...
between group A and B? & Demographic factor\\
2 &  Scatter plot & \begin{minipage}[t]{2cm}  \begin{center} \scalebox{0.3}{\includegraphics{stat_beta_k1.png}} \end{center} \end{minipage} & Of the scatter plots below which one shows data that has steepest slope? & Demographic factor\\
  3 & Contaminated plot &\begin{minipage}[t]{2cm} \begin{center} \scalebox{0.5}{\includegraphics{stat_contaminated.pdf}} \end{center} \end{minipage} & Of the scatter plots below which one shows data that has steepest slope? & Demographic factor\\
 4 & Polar vs Cartesian & \begin{minipage}[t]{2cm} \begin{center}  \scalebox{0.32}{\includegraphics{stat_polar.pdf}} \end{center} \end{minipage} &Which plot is different?& Demographic factor\\
  5 & Hist vs density & \begin{minipage}[t]{2cm} \begin{center}  \scalebox{0.38}{\includegraphics{stat_density.pdf}} \end{center} \end{minipage} &In which plot is the blue group furthest to the right?& Learning trend and Demographic factor\\  
  6 & Violin vs boxplot & \begin{minipage}[t]{2cm} \begin{center}  \scalebox{0.35}{\includegraphics{stat_violin.pdf}} \end{center} \end{minipage}&  In which plot does the blue group look the most different from  the red group? & Learning trend and Demographic factor\\
  7 & Group separation & \begin{minipage}[t]{2cm} \begin{center}  \scalebox{0.4}{\includegraphics{stat_separation.pdf}} \end{center} \end{minipage} &Which of these plots has the most separation between the coloured groups? & Learning trend and  Demographic factor\\ 
  8 & Sine Illusion & \begin{minipage}[t]{2cm} \begin{center}  \scalebox{0.28}{\includegraphics{stat_sine.pdf}} \end{center} \end{minipage} & In what picture is the size of the curve most consistent? & Demographic factor\\ 
  9 & Gene expression &\begin{minipage}[t]{2cm} \begin{center}  \scalebox{0.45}{\includegraphics{stat_gene.pdf}} \end{center} \end{minipage} & In which of these plots is the green line the steepest, and the spread of the green points relatively small? & Location effect and Demographic factor\\ 
  10 & Test normality & \begin{minipage}[t]{2cm} \begin{center}  \scalebox{0.35}{\includegraphics{stat_normality.pdf}} \end{center} \end{minipage} &Which of these plots is most different from the others? & Demographic factor\\ 
...
\section{Factors Affecting Visual Inference} \label{sec:factor_performance} 
