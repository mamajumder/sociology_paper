...
\begin{table}[htbp]
\centering
\caption{Parameter estimates of Model \eqref{eqn:trend_response} fitted for log time taken to evaluate a lineup. None of the fixed factor effects of attempt ($\alpha_2$ through $\alpha_{10}$) seem to be significantly different from each other at \%1 level in all three experiments 5, 6 and 7. For experiment 7 subject specific variation is very small on the other hand lineup variance is much higher compared to the other two experiments.}
\scalebox{0.9}{
...
$\mu$ & -1.304 & 0.179 & -7.28 & $<$0.001 &   & -0.220 & 0.147 & -1.5 & 0.134 &   & -1.737 & 0.481 & -3.61 & $<$0.001 \\ 
  ...
  $\alpha_6$ & 0.042 & 0.231 & 0.18 & 0.857 &   & 0.246 & 0.158 & 1.56 & 0.12 &   & 0.026 & 0.407 & 0.06 & 0.949 \\ 
