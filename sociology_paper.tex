...
Observer demographics seem to have significant influence on performance in time taken to evaluate a lineup. Some variation is observed in terms of probability of correct evaluation. Age group 36-40, Countries other than India and United states, People who have a graduate degree appear to have significantly more probability to evaluate a lineup correctly. Gender does not have any effect on performance.

Individual learning trend is observed in both time taken and observer performance. But the overall performance of human observers does not increase through successive attempts while evaluating multiple lineups. The skill in evaluating the lineup in shorter time gets improved over successive evaluations. The earlier evaluations take significantly longer than the later evaluations. This result is very important as it suggests that the power estimated for visual inference using human subject experiment is robust and may not change if those participants are allowed to give feedback again. This investigation suggest that the skilled person may only do it faster.
