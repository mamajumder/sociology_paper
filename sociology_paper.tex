...
\cline{2-5} \cline{7-10} \cline{12-15} 
 Effect& Est & SE & Zval & $p$-value && Est & SE & Zval & $p$-value && Est & SE & Zval & $p$-value \\ 
  \hline
Fixed &  &  &  & && &  & & & & & &  & \\ 
$\mu$ & 3.817 & 0.039 & 97.38 & $<$0.001 &   & 3.901 & 0.033 & 118.19 & $<$0.001 &   & 3.731 & 0.054 & 69.04 & $<$0.001 \\   $\alpha_1$ & 0.326 & 0.035 & 9.35 & $<$0.001 &   & 0.335 & 0.029 & 11.4 & $<$0.001 &   & 0.280 & 0.050 & 5.63 & $<$0.001 \\   $\alpha$ & -0.038 & 0.004 & -9.3 & $<$0.001 &   & -0.039 & 0.004 & -10.19 & $<$0.001 &   & -0.029 & 0.007 & -4.22 & $<$0.001 \\ 
...
\begin{table}[htbp]
\centering
\caption{Parameter estimates of Model \eqref{eqn:trend_response} fitted for log time taken to evaluate a lineup. None of the fixed factor effects of attempt (2-10) seem to be significantly different from each other at \%5 level in all three experiments 5, 6 and 7.}
\scalebox{0.9}{
\begin{tabular}{rrrrccrrrccrrrc}
  \hline
& \multicolumn{4}{c} {Experiment 5} & &\multicolumn{4}{c} {Experiment 6} && \multicolumn{4}{c} {Experiment 7}\\
