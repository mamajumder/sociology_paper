...
Author response: *Agreed, it could be done differently, but this approach is simple and familiar. The statistical significance is meaningful and it encourages a discussion of effect size and practical significance.* XXX DC thinks this needed re-writing **When you say the variability is in lineup difficulty, it might be better to state it as in the random effects, in various places in the paper.**
...
Author response: *We have removed the detailed of the calculation on page 6 and report only the final number.*
