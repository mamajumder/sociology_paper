...
For a lineup with a predicted random effect of one standard deviation, i.e. we move away one standard deviation of lineup variation by adding 2.293 to each of the exponent terms in the equation, this difference reduces to 0.024. For two standard deviations it further reduces to 0.003 which is practically very small. Figure~\ref{fig:practical_impact_demographics} illustrates this example showing how the change in probability diminishes for larger variability of lineup difficulty. A similar calculation shows the same negligible impact of age level 36-40 (0.0533 at most)  and country (0.0424 at most) on the probability of correct response. Thus even though some of the factor levels are significant, their practical impact is negligible because of high variability of lineup difficulties.
