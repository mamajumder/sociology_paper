...
These samples are plotted as electoral buildings, and the plot made with the results from the election is placed randomly among them in a lineup of size $5\times 4$. If the null hypothesis is true, the actual data plot should look  like any of the other plots, and not be identifiable by an observer. Figure~\ref{fig:tower} shows the plot of the electoral building with added context information and labels.
