...
\hh{
Let $\pi_{ijk}$ be the probability that  observer $i$ picks the data panel from lineup $j$ in his/her $k$th attempt. We model this in a mixed effects model of the form
\begin{equation} \label{eqn:trend}
