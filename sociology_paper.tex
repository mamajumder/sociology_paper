...
\begin{table*}[hbtp] 
\centering 
\caption{Visual test statistics used in 10 different simulation experiments. The observers are asked different questions to answer while evaluating a lineup. All the experiment data are used to estimate the effect of demographic factors (DF) on visual inference while some are used to estimate the learning trend (LT) and location effect (LE) of actual data in the lineup as shown in the right most column.} 
\begin{tabular}{m{.5cm}m{2.6cm}m{2cm}m{5.5cm}m{3cm}} 
\hline\hline 
Serial & Experiment &  Test Statistic  & Lineup question & Designed to study\\ [0.5ex] % inserts table %heading 
\hline 
